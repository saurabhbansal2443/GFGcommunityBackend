    ...
    if (!req.user) {
      ...
      try {
        ...
        if (existingFollow) {
            ...
            return res.status(200).send({ result: true , message : "removed follow" , data : deletedFollow})
        }else{
...
// add/remove follow 
// getMy/others Followers (aggeagtion humne kisko follow kiya hai )
// getMy/others following ( kon kon humme follow karta hai )
